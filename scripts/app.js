...
angular.module('EDRLightbox').directive('stateCtrl', ['$http', '$rootScope', function ($http, $rootScope) {
    return {
        ...
        link: function ($scope) {
            $http.get('scripts/json/states.js').success(function (data) {
                $scope.States = data;
...
angular.module('EDRLightbox').directive('industryCtrl', ['$http', '$rootScope', function ($http, $rootScope) {
    return {
        ...
        link: function ($scope) {
            $http.get('scripts/json/industry.js').success(function (data) {
                $scope.Industry = data;
                console.log("sss " + data);
            });
        }
...
angular.module('EDRLightbox').directive('panelCtrl', ['$http', '$rootScope', function ($http, $rootScope) {
    return {
        ...
        link: function ($scope) {
            $http.get('scripts/json/panelData.js').success(function (data) {
